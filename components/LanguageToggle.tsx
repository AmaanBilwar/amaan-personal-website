...
export default function LanguageToggle() {
  ...
  return (
    ...
    >
      {/* Language labels */}
      <span
        className={`text-sm transition-colors duration-200 ${language === 'en' ? 'text-white' : 'text-stone-500'}`}
      >
        EN
      </span>
      ...
      <span
        className={`text-sm transition-colors duration-200 ${language === 'zh' ? 'text-white' : 'text-stone-500'}`}
      >
        中文
      </span>
