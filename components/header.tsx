...
export default function Header() {
  ...
  return (
    <header className="fixed top-2 md:top-4 left-1/2 transform -translate-x-1/2 z-50 w-[95%] md:w-[85%] lg:w-[80%] xl:w-[70%]">
      <div className="bg-[#1a1a1a]/60 backdrop-blur-2xl border border-stone-600/50 rounded-full px-3 md:px-8 py-2 md:py-3 flex items-center gap-2 md:gap-6 shadow-2xl backdrop-saturate-150 max-w-full">
        {/* Logo */}
