...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'blog.coding.item22': '• learned about unit and integration tests',
    'blog.coding.item23': '• learned a lot of git commands including git cherry-pick',
    'blog.coding.item24': '• built a dependabot clone with a friend during my free time',
    'blog.coding.item25': '• built a trash sorter at hack the 6ix with rbc friends',
    'blog.coding.item26':
      '• worked in a production codebase developing internal tools for the team',
    'blog.coding.item27': '• learned typescript, next.js, vite and react and used postman a lot',
    'blog.coding.item28': '• messed around with postgres, sql and the debugger for the first time',
    'blog.coding.item29':
      '• got more familiar with the terminal and ai and used stack overflow still',
    'blog.coding.item30': '• won 2nd place by building a posture checking robot at utra hacks',
    'blog.coding.item31':
    ...
    'blog.coding.item34': '• made an etl pipeline that processed customer feedback',
    'blog.coding.item35': '• built a discord summarizer bot using python for fun at 2am',
    'blog.coding.item36': '• used golang for the first time and built an image processor',
    'blog.coding.item37':
      '• made this facial recognition software for fun in python and typescript',
    'blog.coding.item38': '• tried learning haskell for the first time',
    'blog.coding.item39':
    ...
    'blog.coding.item41': '• landed a software engineering internship at textql for the fall',
    'blog.coding.item42': '• had to learn matlab for one of my uni courses during school',
    'blog.coding.item43': '• built a url shortener using golang and tailwind css hosted on railway',
    'blog.coding.item44': '• made a mini worse version of figma',
    'blog.coding.item45': '• did many takehomes and coding assignments to learn system design',
    'blog.coding.item46': '• redesigned my entire personal website twice',
    'blog.coding.item47': '• coworker told me to start using iterm2 and i fell in love',
    'blog.coding.item48': '• used a lot of claude code, codex and cursor when programming',
    'blog.coding.item49': '• worked on the textql healthcare landing page',
    'blog.coding.item50': '• learned how to use the terminal better than before',
    'blog.coding.item51':
      '• worked at a startup and used a lot of go, python, typescript and svelte',
    'blog.coding.item52': '• worked on the ontology a lot at textql',
    'blog.coding.item53': '• did a lot of agentic and applied ai work',
    'blog.coding.item54': '• learned even more git commands including git bisect',
    'blog.coding.item55': '• broke prod at textql 4 times and learned how to debug and fix it',
    'blog.coding.item56': '• learned rust for the first time and built some random things',
    'blog.coding.item57': '• participated in a mercor ML model challenge with friend',
    'blog.coding.item58': '• did some benchmarking with web search apis for the first time',
    'blog.coding.item59': '• started learning some system design for programming',
  ...
  zh: {
    ...
    'blog.coding.item22': '• 学习了单元测试和集成测试',
    'blog.coding.item23': '• 学到了很多 git 命令，包括 git cherry-pick',
    'blog.coding.item24': '• 在空闲时间与朋友一起构建了一个 dependabot 克隆',
    'blog.coding.item25': '• 与 rbc 朋友一起在 hack the 6ix 构建了一个垃圾分拣器',
    'blog.coding.item26': '• 在生产代码库中工作，为团队开发内部工具',
    'blog.coding.item27': '• 学习了 typescript、next.js、vite 和 react，并大量使用 postman',
    'blog.coding.item28': '• 第一次玩弄 postgres、sql 和调试器',
    'blog.coding.item29': '• 更熟悉终端和 ai，并仍然使用 stack overflow',
    'blog.coding.item30': '• 通过在 utra hacks 构建姿势检查机器人获得第二名',
    'blog.coding.item31': '• 在大学第二学期学习 C++ 中的数据结构和算法',
    'blog.coding.item32': '• 上了 twitter，在那里学到了很多，并遇到了其他酷的 cs 学生',
    'blog.coding.item33': '• 开始更认真地对待 leetcode，并在 yt 上看了很多 neetcode',
    'blog.coding.item34': '• 制作了一个处理客户反馈的 etl 流水线',
    'blog.coding.item35': '• 用 python 构建了一个 discord 摘要机器人，在凌晨 2 点玩耍',
    'blog.coding.item36': '• 第一次使用 golang 并构建了一个图像处理器',
    'blog.coding.item37': '• 用 python 和 typescript 制作了这个面部识别软件',
    'blog.coding.item38': '• 第一次尝试学习 haskell',
    'blog.coding.item39': '• 用 typescript 和 svelte 构建了 sql 查询解析器，用于解析扁平 json',
    'blog.coding.item40': '• 创建了 diff digest 工具，用于获取 github pr diffs 以进行 ai 摘要',
    'blog.coding.item41': '• 在秋季获得了 textql 的软件工程实习',
    'blog.coding.item42': '• 在学校期间必须为其中一门大学课程学习 matlab',
    'blog.coding.item43': '• 使用 golang 和 tailwind css 构建了一个 url 缩短器，托管在 railway 上',
    'blog.coding.item44': '• 制作了一个 figma 的小型劣质版本',
    'blog.coding.item45': '• 做了很多带回家的作业和编码任务来学习系统设计',
    'blog.coding.item46': '• 重新设计了我的整个个人网站两次',
    'blog.coding.item47': '• 同事告诉我开始使用 iterm2，我爱上了它',
    'blog.coding.item48': '• 在编程时大量使用了 claude code、codex 和 cursor',
    'blog.coding.item49': '• 参与了 textql 医疗保健登录页面',
    'blog.coding.item50': '• 学习了如何比以前更好地使用终端',
    'blog.coding.item51': '• 在一家初创公司工作，大量使用 go、python、typescript 和 svelte',
    'blog.coding.item52': '• 在 textql 大量处理本体',
    'blog.coding.item53': '• 做了很多代理和应用 ai 工作',
    'blog.coding.item54': '• 在 textql 破坏了生产环境 4 次并学会了如何调试和修复',
    'blog.coding.item56': '• 第一次学习 rust 并构建了一些随机东西',
    'blog.coding.item57': '• 与朋友一起参加了 mercor ML 模型挑战',
    'blog.coding.item58': '• 第一次使用网络搜索 api 进行一些基准测试',
    'blog.coding.item59': '• 开始学习一些编程的系统设计',
