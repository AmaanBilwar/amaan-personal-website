...
export default function OntologyTextToSqlBlog() {
  ...
  const sections: TOCSection[] = useMemo(
    () => [
      { id: 'what-is', title: t('blog.scene-ai-when.section1.title') },
  ...
  useEffect(() => {
    ...
    document.title = `${t('blog.scene-ai-when.title')} | Amaan Bilwar`;
  }, [t]);
    ...
    <main className="min-h-screen bg-[#1a1a1a] text-stone-300 pb-12 px-4 md:px-8">
      <div className="max-w-6xl mx-auto pt-12 flex gap-8 items-start justify-center">
        ...
        <article className="w-full lg:max-w-lg">
          ...
          <p className="text-stone-500 text-sm mb-6">{t('blog.scene-ai-when.date')}</p>

          {/* Cover image */}
          <img
            src="/blogs/scene-ai-when/placeholder.svg"
            alt={t('blog.scene-ai-when.coverAlt')}
          ...
          <div className="space-y-8 text-xs md:text-sm leading-relaxed" style={{ fontWeight: 400 }}>
            <section>
              ...
              <figure className="mt-6">
                <img
                  src="/blogs/scene-ai-when/placeholder.svg"
                  alt={t('blog.scene-ai-when.section1.imageAlt')}
                  className="w-full"
                />
            ...
            <section>
              ...
              <figure className="mt-6">
                <img
                  src="/blogs/scene-ai-when/placeholder.svg"
                  alt={t('blog.scene-ai-when.section2.imageAlt')}
                  className="w-full"
                />
                <figcaption className="text-stone-500 text-xs mt-2 italic">
            ...
            <section>
              <h2
                ...
                className="text-lg md:text-xl font-semibold text-stone-100 mb-3 scroll-mt-8"
              >
                {t('blog.scene-ai-when.section3.title')}
              </h2>
              <p>{t('blog.scene-ai-when.section3.p1')}</p>
              <figure className="mt-6">
                <img
                  src="/blogs/scene-ai-when/placeholder.svg"
                  alt={t('blog.scene-ai-when.section3.image1Alt')}
                  className="w-full"
                />
                <figcaption className="text-stone-500 text-xs mt-2 italic">
                  {t('blog.scene-ai-when.section3.image1Caption')}
                </figcaption>
              </figure>
            ...
            <section>
              <h2
                ...
                className="text-lg md:text-xl font-semibold text-stone-100 mb-3 scroll-mt-8"
              >
                {t('blog.scene-ai-when.section4.title')}
              </h2>
            ...
            <section className="border-t border-stone-700 pt-6 mt-8">
              <h3 className="text-sm md:text-base font-semibold text-stone-200 mb-3">
                {t('blog.scene-ai-when.referencesTitle')}
              </h3>
              <ul className="space-y-2 text-stone-400 text-sm">
                <li>
                  <a
                    href={t('blog.scene-ai-when.references.item1')}
                    target="_blank"
