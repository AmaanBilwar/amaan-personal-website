...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'blog.coding.item43': '• made a mini worse version of figma because i was bored one day',
  ...
  zh: {
    ...
    'blog.coding.item43': '• 制作了一个 figma 的小型劣质版本，因为有一天我很无聊',
    ...
    'blog.ontology.referencesTitle': '参考',
    'blog.ontology.note': '注：所有图像在原文中都是生成的或从 textql 拿的',
  },
};
